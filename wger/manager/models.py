...
class Workout(models.Model):
    ...
    def canonical_representation(self):
        ...
        As an additional benefit, the template caches are not needed anymore.
        '''
...
class Schedule(models.Model):
    ...
    name = models.CharField(verbose_name=_('Name'),
                            max_length=100,
                            help_text=_("Name or short description of the"
    ...
    '''A flag indicating whether the schedule is
    active (needed for dashboard)'''
...
class Day(models.Model):
    ...
    description = models.CharField(max_length=100,
                                   verbose_name=_('Description'),
                                   help_text=_('A description of what is done '
                                               'on this day (e.g. '
    ...
    def get_first_day_id(self):
        '''
        Return the PK of the first day of the week, this is used in
        the template to order the days in the template
        '''
    ...
    def canonical_representation(self):
        ...
        This is extracted from the workout representation because that one
        is cached and this isn't.
        '''
        ...
        for set_obj in self.set_set.select_related():
            ...
            for exercise in set_obj.exercises.select_related():
                ...
                setting_text, setting_list, weight_list, reps_list, \
                    repetition_units, weight_units = reps_smart_text(
                        setting_tmp, set_obj)
            ...
            # repetitions. If not, just take the smallest number and drop
            # the rest, because otherwise it doesn't make sense
...
class WorkoutLog(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        '''
        reset_workout_log(
            self.user_id, self.date.year, self.date.month, self.date.day)
    ...
    def clean(self):
        ...
        if (not self.time_end and self.time_start) \
            ...
            raise ValidationError(_(
                "If you enter a time, you must enter "
