# -*- coding: utf-8 -*-
# Generated by Django 1.9.12 on 2017-04-24 23:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='exercise',
            field=models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='comment', to='exercises.Exercise', verbose_name='Exercise'),
        ),
        migrations.AlterField(
            model_name='exerciseimage',
            name='exercise',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='image', to='exercises.Exercise', verbose_name='Exercise'),
        ),
        migrations.AlterField(
            model_name='exerciseimage',
            name='is_main',
